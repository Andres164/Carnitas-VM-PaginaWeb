<?php
  ...
  if( isset($_POST['accion']) ) {
    if($_POST['accion'] == 'Registrar') {
      require '../../interfazDB/insumos/create.php';
...
<?php require '../navBar.php'; ?>
  ...
  <div class="b-example-divider"><h1 style="margin-left: 15px;">Insumos</h1></div>
    ...
    <div class="container-fluid " id="mainDiv">
        ...
        <div class="col-8" id="divDataGrid">
                    ...
                    <tbody>
                      ...
                      while($registro = mysqli_fetch_array($datos)) {
                        echo '<tr>';
                          ...
                          echo '<td> <form method="POST"> <button name="' . $registro['insumoID']  . '" type="submit" class="w-100 btn btn-secondary">-</button></td> </form>';
                        echo '</tr>';
                      }
                      ?>
                    </tbody>
            ...
            <div class="col-4" id="divBotones">
                <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="w-100 btn btn-secondary">Registrar insumo</button><br>
                <br>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <h5>Nombre</h5>
              <input type="text" step="any" name="nombre" required><br>
            </div>
            <div class="modal-body">
                <h5>Unidad de medida</h5>
                <input type="text" step="any" name="unidadDeMedida" required><br>
            </div>
            <div class="modal-body">
                <h5>Categoria</h5>
                <input type="text" step="any" name="categoria" required><br>
            </div>
            <div class="modal-body">
                <h5>Stock</h5>
    ...
    <form method="POST" class="modal fade" id="modificarRegModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h5>Nombre</h5>
            <input type="" step="any" name="nombre" required><br>
          </div>
          <div class="modal-body">
              <h5>Unidad de medida</h5>
              <input type="text" step="any" name="unidadDeMedida" required><br>
